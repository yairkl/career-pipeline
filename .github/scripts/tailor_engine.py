...
1. Keeping all information truthful and factual (no hallucinations)
2. Using impact-driven language (action verbs, quantified results, technical keywords)
3. Matching the target role's terminology and requirements
4. Preserving the original structure and markdown formatting
5. Only modifying content that is relevant to the JD
